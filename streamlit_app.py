#!/usr/bin/env python3
"""
Trading Compliance Validator - Public Web App
...
from frontend.validation_wrapper import validate_trades_csv, get_csv_download_content, get_validation_summary
    ...
    if total_violations > 0:
        with st.expander("🚨 Violations Found", expanded=True):
            ...
            if not violations_df.empty:
                ...
                styled_df = violations_df[['ticket', 'pair', 'direction', 'lot_size', 'profit', 'violation_type', 'rule_status']].style.map(
